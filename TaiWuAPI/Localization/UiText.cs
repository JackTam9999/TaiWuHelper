...
public static class UiText
{
    private static readonly Dictionary<string, string>
            ...
            StringComparer.Ordinal)
        {
            ...
            ["Consummate level"] = "精純",
            ["Selected target"] = "已選目標",
            ["Choose this target"] = "選擇此目標",
            ...
            ["Current baseline provenance"] = "目前基準資料來源",
            ["Comparison rows"] = "比較列",
            ["All rows"] = "所有列",
            ["Differences only"] = "僅顯示差異",
            ["skill row(s) shown"] = "列功法",
            ...
            ["View setup checklist and battle plan"] =
                "查看設定檢查表與戰鬥計劃",
            ["Remaining"] = "剩餘",
            ["Comparison status legend"] = "比較狀態圖例",
            ["Legend"] = "圖例",
            ["Present"] = "目前已裝備",
            ["Retained"] = "保留",
            ["Added"] = "新增",
            ["Removed"] = "移除",
            ["Direction change required"] = "需要更改正逆練",
            ["Breakthrough required"] = "需要突破",
            ["Current loadout"] = "目前運功",
            ["Baseline used for this result"] = "本次結果採用的基準",
            ["manual action(s)"] = "項手動操作",
            ["Feasible policy winner"] = "策略的可行最佳方案",
            ["No feasible proposal"] = "沒有可行方案",
            ["Change to"] = "更改為",
            ["breakthrough"] = "突破",
            ["Not equipped"] = "未裝備",
            ["Not part of this policy"] = "不在此策略方案中",
            ["Equipped skills"] = "已裝備功法",
            ["Slot budgets"] = "格位容量",
            ...
            ["Skill details"] = "功法詳情",
            ["Show detailed skill cards"] = "顯示功法卡詳情",
            ["skill(s)"] = "項功法",
            ["Target profile"] = "目標特徵",
            ["Reusable response strategy"] = "可重用的應對策略",
            ["Snapshot"] = "快照",
            ["Profile rule"] = "特徵規則",
            ["source(s)"] = "項來源",
            ["Verified target profile facts"] = "已驗證的目標特徵",
            ["Target patterns checked"] = "已檢查的目標類型",
            ["Why this state"] = "此狀態的依據",
            ["Supporting facts"] = "支持特徵",
            ["Missing facts"] = "缺少特徵",
            ["Contrary facts"] = "相反特徵",
            ["Conflicting facts"] = "衝突特徵",
            ["Reusable response goals"] = "可重用的應對目標",
            ["No verified playbook goal is available for this profile state."] =
                "此特徵狀態沒有可用的已驗證策略目標。",
            ["Confirmed for this target"] = "已由此目標確認",
            ["Needs exact confirmation"] = "需要精確證據確認",
            ["Linked threats"] = "關聯威脅",
