...
public sealed class FindVillageWorkforce(
    IVillageWorkforceSnapshotReader snapshotReader) : IFindVillageWorkforce
{
    ...
    private static bool ValidRequest(VillageWorkforceFinderRequest request)
    {
