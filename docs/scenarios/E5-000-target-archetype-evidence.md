...
|---|---|---|---|---|
| `MIND_RESONANCE_RESET_BASELINE` | Existing exact magic-sound direction, distraction, resonance, defeat-threshold reset, threat, effect, and counter rules | Historical golden scenario in [M1-001](M1-001-golden-target-selection.md) and the verified reset evidence in [M1-025](../reviews/M1-025-manual-verification.md) | Preserve the existing ordered survival, interruption/mitigation, resonance, and reset-pressure goals | Baseline selected |
